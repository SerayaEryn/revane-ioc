...
test('should add configuration properties', async (t) => {
  ...
  options.configuration = { disabled: false, directory: join(import.meta.dirname, '../../../testdata/configurationProperties/testconfig') }
...
test('should add configuration properties #2', async (t) => {
  ...
  options.configuration = { disabled: false, directory: join(import.meta.dirname, '../../../testdata/configurationProperties2/testconfig') }
  options.profile = 'test'
  const revane = new Revane(options)
  await revane.initialize()
...
test('should add configuration properties #3', async (t) => {
  ...
  options.loaderOptions = []
  options.configuration = { disabled: false, directory: join(import.meta.dirname, '../../../testdata/configurationProperties3/testconfig') }
  options.profile = 'test'
  const revane = new Revane(options)
  await revane.initialize()
...
test('should add configuration properties from yaml #1', async (t) => {
  ...
  options.loaderOptions = []
  options.configuration = { disabled: false, directory: join(import.meta.dirname, '../../../testdata/configurationPropertiesYml1/testconfig') }
  options.profile = 'test'
  const revane = new Revane(options)
  await revane.initialize()
...
test('should add configuration properties from yaml #2', async (t) => {
  ...
  options.loaderOptions = []
  options.configuration = { disabled: false, directory: join(import.meta.dirname, '../../../testdata/configurationPropertiesYml2/testconfig') }
  options.profile = 'test'
  const revane = new Revane(options)
  await revane.initialize()
...
test('should add configuration properties from yaml and replace env vars', async (t) => {
  ...
  options.loaderOptions = []
  options.configuration = { disabled: false, directory: join(import.meta.dirname, '../../../testdata/configurationPropertiesYml3/testconfig') }
  options.profile = 'test'
  const revane = new Revane(options)
  await revane.initialize()
...
test('should add configuration properties from properties #1', async (t) => {
  ...
  const options = new Options(
    join(import.meta.dirname, '../../../testdata/configurationPropertiesProperties1'),
    [new MockedExtension([
      beanDefinition('scan56', ConfigurationProperties7)
    ])]
  )
  options.loaderOptions = []
  options.configuration = { disabled: false, directory: join(import.meta.dirname, '../../../testdata/configurationPropertiesProperties1/testconfig') }
  options.profile = 'test'
  const revane = new Revane(options)
  await revane.initialize()
...
test('should add configuration properties from properties #2', async (t) => {
  ...
  const options = new Options(
    join(import.meta.dirname, '../../../testdata/configurationPropertiesProperties2'),
    [new MockedExtension([
      beanDefinition('scan56', ConfigurationProperties8)
    ])]
  )
  options.loaderOptions = []
  options.configuration = { disabled: false, directory: join(import.meta.dirname, '../../../testdata/configurationPropertiesProperties2/testconfig') }
  options.profile = 'test'
  const revane = new Revane(options)
  await revane.initialize()
...
test('should add configuration properties from properties and replace env vars', async (t) => {
  ...
  process.env.A_ENV_VAR = 'a env var'
  const options = new Options(
    join(import.meta.dirname, '../../../testdata/configurationPropertiesProperties3'),
    [new MockedExtension([
      beanDefinition('scan56', ConfigurationProperties9)
    ])]
  )
  options.loaderOptions = []
  options.configuration = { disabled: false, directory: join(import.meta.dirname, '../../../testdata/configurationPropertiesProperties3/testconfig') }
  options.profile = 'test'
  const revane = new Revane(options)
  await revane.initialize()
